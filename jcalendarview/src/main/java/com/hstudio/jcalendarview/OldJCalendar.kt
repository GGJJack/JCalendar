...
class OldJCalendar : ViewPager {
    constructor(context: Context) : super(context)
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs)

    internal var pagerAdapter: OldJCalenderPagerAdapter<JCalendarAdapter<*, *>>? = null
    ...
    init {
        ...
        this.viewTreeObserver.addOnGlobalLayoutListener(object: ViewTreeObserver.OnGlobalLayoutListener {
            override fun onGlobalLayout() {
                this@OldJCalendar.viewTreeObserver.removeOnGlobalLayoutListener(this)
                pagerAdapter?.let {
                    it.viewMaxHeight = this@OldJCalendar.height
                }
            }
        })
    }
    ...
    fun <T : JCalendarAdapter<*, *>> calendarAdapter(adapterClass: Class<T>) {
        ...
        val adapter = OldJCalenderPagerAdapter(adapterClass) as OldJCalenderPagerAdapter<JCalendarAdapter<*, *>>
